 ...
 * @author Travis
 */
public class Necromancer extends SpellClass{
    private final String className = "necromancer";
    Integer[] sanctum =  {3804,90,3819};
//    Material menuItem = Material.DIAMOND_CHESTPLATE;
//    ChatColor chatColor = ChatColor.DARK_RED;

    public Necromancer(Player player, MagicSpells plugin) {
        //Create the spellMap
        super();
