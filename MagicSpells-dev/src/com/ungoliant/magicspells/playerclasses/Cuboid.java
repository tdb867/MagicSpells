...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
	...
	public Cuboid(Location l1) {
        ...
        /**
	 * Construct a multi-block Cuboid at the given Location of the Cuboid.
	 * 
	 * @param l1 location of the Cuboid
         * @param expand size of the Cuboid
	 */
	public Cuboid(Location l1, int expand) {
            this.worldName = l1.getWorld().getName();
            this.x1 = l1.getBlockX()-expand;
            this.y1 = l1.getBlockY()-expand;
            this.z1 = l1.getBlockZ()-expand;
            this.x2 = l1.getBlockX()+expand;
            this.y2 = l1.getBlockY()+expand;
            this.z2 = l1.getBlockZ()+expand;
